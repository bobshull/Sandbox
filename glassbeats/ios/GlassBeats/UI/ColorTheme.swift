...
struct ColorTheme {
    ...
    // ── Sea Glass ──────────────────────────────────────────────────────────
    static let seaGlass = ColorTheme(id: "seaGlass", name: "Sea Glass", colors: [
    ...
    // ── Night Swim ─────────────────────────────────────────────────────────
    static let nightSwim = ColorTheme(id: "nightSwim", name: "Night Swim", colors: [
        ...
        "pad":   (hex("22d3ee"), hex("18a1b6")),   // cyan shimmer
    ...
    // ── Sour Apple ─────────────────────────────────────────────────────────
    static let sourApple = ColorTheme(id: "sourApple", name: "Sour Apple", colors: [
    ...
    // ── Northern Glow ──────────────────────────────────────────────────────
    static let northernGlow = ColorTheme(id: "northernGlow", name: "Northern Glow", colors: [
