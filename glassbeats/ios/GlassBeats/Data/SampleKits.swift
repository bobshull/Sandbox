...
enum SampleKits {
    static let all: [SampleKit] = [
        ...
        SampleKit(id: "analog",      name: "Analog"),
        SampleKit(id: "house",       name: "House"),
        SampleKit(id: "trap",        name: "Trap"),
        SampleKit(id: "garage",      name: "Garage"),
        SampleKit(id: "minimal",     name: "Minimal"),
        SampleKit(id: "lo-fi",       name: "Lo-Fi"),
        SampleKit(id: "breakbeat",   name: "Breakbeat"),
        ...
        SampleKit(id: "kalimba",     name: "Kalimba"),
