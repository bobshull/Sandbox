...
private extension Synths {
    static func renderKick(kit: String, sampleRate: Double) -> [Float] {
        ...
        switch kit {
        case "analog":      len = 0.42; startF = 165; endF = 42; sweepT = 0.16; decayT = 0.18; peak = 0.95
        case "house":       len = 0.34; startF = 135; endF = 45; sweepT = 0.12; decayT = 0.16; peak = 1.00
        case "trap":        len = 0.72; startF = 95;  endF = 30; sweepT = 0.30; decayT = 0.48; peak = 0.92
        case "garage":      len = 0.30; startF = 155; endF = 48; sweepT = 0.10; decayT = 0.12; peak = 0.90
        case "minimal":     len = 0.24; startF = 120; endF = 50; sweepT = 0.08; decayT = 0.10; peak = 0.78
        case "lo-fi":       len = 0.42; startF = 105; endF = 36; sweepT = 0.24; decayT = 0.25; peak = 0.72
        case "breakbeat":   len = 0.32; startF = 175; endF = 44; sweepT = 0.10; decayT = 0.12; peak = 0.98
        ...
        case "kalimba":     len = 0.24; startF = 220; endF = 180; sweepT = 0.018; decayT = 0.12; peak = 0.42
...
private extension Synths {
    static func renderSnare(kit: String, sampleRate: Double) -> [Float] {
        ...
        switch kit {
        case "analog":
            len = 0.30; hpAlpha = 0.92; noiseDecay = 0.11; noisePeak = 0.68
            bodyFreq = 230; bodyDecay = 0.07; bodyPeak = 0.36
        case "house":
            len = 0.22; hpAlpha = 0.97; noiseDecay = 0.06; noisePeak = 0.90
            bodyFreq = 260; bodyDecay = 0.04; bodyPeak = 0.30
        case "trap":
            len = 0.30; hpAlpha = 0.95; noiseDecay = 0.10; noisePeak = 0.78
            bodyFreq = 190; bodyDecay = 0.06; bodyPeak = 0.22
        case "garage":
            len = 0.24; hpAlpha = 0.96; noiseDecay = 0.07; noisePeak = 0.82
            bodyFreq = 245; bodyDecay = 0.05; bodyPeak = 0.32
        case "minimal":
            len = 0.18; hpAlpha = 0.94; noiseDecay = 0.05; noisePeak = 0.52
            bodyFreq = 210; bodyDecay = 0.04; bodyPeak = 0.18
        case "lo-fi":
            len = 0.34; hpAlpha = 0.82; noiseDecay = 0.17; noisePeak = 0.42
            bodyFreq = 165; bodyDecay = 0.13; bodyPeak = 0.26
        case "breakbeat":
            len = 0.24; hpAlpha = 0.97; noiseDecay = 0.07; noisePeak = 0.92
            bodyFreq = 275; bodyDecay = 0.045; bodyPeak = 0.38
        case "dusty-tape":
        ...
        case "kalimba":
            len = 0.20; hpAlpha = 0.92; noiseDecay = 0.015; noisePeak = 0.10
            bodyFreq = 784; bodyDecay = 0.11; bodyPeak = 0.50
        case "jungle":
...
private extension Synths {
    static func renderHat(kit: String, sampleRate: Double) -> [Float] {
        ...
        switch kit {
        case "analog":      len = 0.07; decayT = 0.030; peak = 0.40
        case "house":       len = 0.055; decayT = 0.018; peak = 0.48
        case "trap":        len = 0.045; decayT = 0.014; peak = 0.52
        case "garage":      len = 0.060; decayT = 0.020; peak = 0.50
        case "minimal":     len = 0.035; decayT = 0.010; peak = 0.36
        case "lo-fi":       len = 0.12; decayT = 0.080; peak = 0.20
        case "breakbeat":   len = 0.050; decayT = 0.015; peak = 0.56
        ...
        case "kalimba":     len = 0.05;  decayT = 0.018; peak = 0.28
...
private extension Synths {
    static func renderClap(kit: String, sampleRate: Double) -> [Float] {
        ...
        switch kit {
        case "analog":      len = 0.24; peak = 0.58; finalDecay = 0.10
        case "house":       len = 0.18; peak = 0.72; finalDecay = 0.06
        case "trap":        len = 0.18; peak = 0.70; finalDecay = 0.07
        case "garage":      len = 0.16; peak = 0.76; finalDecay = 0.05
        case "minimal":     len = 0.14; peak = 0.45; finalDecay = 0.04
        case "lo-fi":       len = 0.30; peak = 0.32; finalDecay = 0.16
        case "breakbeat":   len = 0.17; peak = 0.82; finalDecay = 0.055
        ...
        case "kalimba":     len = 0.14; peak = 0.36; finalDecay = 0.05
...
private extension Synths {
    static func renderBass(kit: String, sampleRate: Double, freqRatio: Double = 1.0) -> [Float] {
        ...
        switch kit {
        case "analog":
            len = 0.36; freq = 55; lpStart = 1800; lpEnd = 200; sweepT = 0.18; decayT = 0.18; peak = 0.66
        case "house":
            len = 0.32; freq = 49; lpStart = 2200; lpEnd = 260; sweepT = 0.14; decayT = 0.14; peak = 0.68
        case "trap":
            len = 0.55; freq = 41; lpStart = 1800; lpEnd = 240; sweepT = 0.18; decayT = 0.32; peak = 0.76; useSine = true
        case "garage":
            len = 0.30; freq = 55; lpStart = 2400; lpEnd = 320; sweepT = 0.12; decayT = 0.13; peak = 0.64
        case "minimal":
            len = 0.24; freq = 55; lpStart = 1400; lpEnd = 180; sweepT = 0.12; decayT = 0.10; peak = 0.45; useSine = true
        case "lo-fi":
            len = 0.42; freq = 49; lpStart = 700; lpEnd = 110; sweepT = 0.26; decayT = 0.24; peak = 0.50; useSine = true
        case "breakbeat":
            len = 0.30; freq = 49; lpStart = 2000; lpEnd = 240; sweepT = 0.12; decayT = 0.14; peak = 0.62
        case "dusty-tape":
        ...
        case "kalimba":
            len = 0.42; freq = 196; lpStart = 12000; lpEnd = 10000; sweepT = 0.01; decayT = 0.24; peak = 0.44; useSine = true
        case "jungle":
...
private extension Synths {
    static func renderPluck(kit: String, sampleRate: Double, freqRatio: Double = 1.0) -> [Float] {
        ...
        switch kit {
        case "analog":      len = 0.34; startF = 440; endF = 360; sweepT = 0.14; decayT = 0.14; peak = 0.50
        case "house":       len = 0.28; startF = 660; endF = 520; sweepT = 0.10; decayT = 0.12; peak = 0.52
        case "trap":        len = 0.25; startF = 740; endF = 560; sweepT = 0.08; decayT = 0.10; peak = 0.50
        case "garage":      len = 0.22; startF = 880; endF = 660; sweepT = 0.07; decayT = 0.08; peak = 0.56
        case "minimal":     len = 0.18; startF = 520; endF = 480; sweepT = 0.05; decayT = 0.07; peak = 0.36
        case "lo-fi":       len = 0.42; startF = 392; endF = 330; sweepT = 0.20; decayT = 0.22; peak = 0.36
        case "breakbeat":   len = 0.26; startF = 740; endF = 520; sweepT = 0.08; decayT = 0.09; peak = 0.55
        ...
        case "kalimba":     len = 0.45; startF = 784;    endF = 770;    sweepT = 0.008; decayT = 0.26; peak = 0.54
        ...
        for i in 0..<count {
            ...
            } else if kit == "marimba" || kit == "glass" || kit == "wind-chimes" || kit == "minimal" || kit == "kalimba" {
...
private extension Synths {
    ...
    static func renderPad(kit: String, sampleRate: Double, freqRatio: Double = 1.0) -> [Float] {
        ...
        switch kit {
        case "analog":
            len = 1.35; baseFreq = 220.00; strumMs = 10; damping = 0.990; brightness = 0.62; peak = 0.32
        case "house":
            len = 1.10; baseFreq = 261.63; strumMs = 8; damping = 0.988; brightness = 0.70; peak = 0.34
        case "trap":
            len = 1.25; baseFreq = 196.00; strumMs = 10; damping = 0.991; brightness = 0.48; peak = 0.30
        case "garage":
            len = 1.00; baseFreq = 246.94; strumMs = 8; damping = 0.986; brightness = 0.78; peak = 0.34
        case "minimal":
            len = 0.90; baseFreq = 220.00; strumMs = 6; damping = 0.984; brightness = 0.42; peak = 0.22
        case "lo-fi":
            len = 1.50; baseFreq = 196.00; strumMs = 14; damping = 0.991; brightness = 0.32; peak = 0.26
        case "breakbeat":
            len = 1.00; baseFreq = 220.00; strumMs = 8; damping = 0.986; brightness = 0.74; peak = 0.32
        case "dusty-tape":
        ...
        case "kalimba":
            len = 1.30; baseFreq = 392.00; strumMs = 10; damping = 0.993; brightness = 0.55; peak = 0.28
        case "jungle":
...
private extension Synths {
    static func renderPerc(kit: String, sampleRate: Double) -> [Float] {
        ...
        switch kit {
        case "analog":      len = 0.10; startF = 1200; endF = 600; sweepT = 0.050; decayT = 0.045; peak = 0.44
        case "house":       len = 0.08; startF = 1800; endF = 900; sweepT = 0.040; decayT = 0.035; peak = 0.50
        case "trap":        len = 0.09; startF = 2200; endF = 1100; sweepT = 0.050; decayT = 0.040; peak = 0.46
        case "garage":      len = 0.07; startF = 1500; endF = 500; sweepT = 0.030; decayT = 0.030; peak = 0.54
        case "minimal":     len = 0.06; startF = 1000; endF = 850; sweepT = 0.020; decayT = 0.025; peak = 0.30
        case "lo-fi":       len = 0.13; startF = 520; endF = 260; sweepT = 0.080; decayT = 0.070; peak = 0.28
        case "breakbeat":   len = 0.07; startF = 1700; endF = 650; sweepT = 0.035; decayT = 0.030; peak = 0.58
        ...
        case "kalimba":     len = 0.10; startF = 1800; endF = 1700; sweepT = 0.006; decayT = 0.060; peak = 0.36
