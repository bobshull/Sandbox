...
final class PatternStoreTests: XCTestCase {
    ...
    private let patternsKey = "glassbeats.userPatterns.v1"
    private let sessionKey = "glassbeats.session.v1"
    private let syncKey = "glassbeats.iCloudSyncEnabled"
    private var defaults: UserDefaults!

    override func setUp() {
        super.setUp()
        let suiteName = "GlassBeats.PatternStoreTests.\(UUID().uuidString)"
